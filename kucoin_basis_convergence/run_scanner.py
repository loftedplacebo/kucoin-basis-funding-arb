...
from kucoin_basis_convergence.config import DEFAULT_CONFIG
from kucoin_basis_convergence.opportunity_scanner import scan_once
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scan KuCoin spot/perp basis-convergence opportunities.")
...
def _run_once() -> None:
    ...
    print(f"Wrote {len(rows)} KuCoin convergence rows to {path}", flush=True)
