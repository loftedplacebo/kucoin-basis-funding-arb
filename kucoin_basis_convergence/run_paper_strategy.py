...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the KuCoin basis-convergence paper strategy.")
...
def main() -> None:
    ...
    while True:
        try:
            ...
            print(f"Fresh rows: {result['fresh_opportunities_seen']}", flush=True)
